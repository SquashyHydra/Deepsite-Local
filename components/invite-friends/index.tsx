        ...
        <DialogContent className="sm:max-w-lg lg:!p-8 !rounded-3xl !bg-white !border-neutral-100">
          ...
          <main>
            ...
            <div className="mt-4 space-x-3.5">
              <a
                href="https://github.com/SquashyHydra/Deepsite-Local?tab=readme-ov-file#deepsite-local-"
                target="_blank"
              ...
              <Button
                ...
                className="!text-neutral-700"
                onClick={() => {
                  copyToClipboard("https://github.com/SquashyHydra/Deepsite-Local?tab=readme-ov-file#deepsite-local-");
